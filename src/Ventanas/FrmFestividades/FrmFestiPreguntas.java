 ...
 * @author 4ser
 */
public class FrmFestiPreguntas extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        pnlText.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/bgPreguntasFesti.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFestiPreguntas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
