 ...
 * @author 4ser
 */
public class FrmBailesTipicosPreguntas extends javax.swing.JFrame implements Runnable {
    ...
    public FrmBailesTipicosPreguntas() {
    ...
    public void inicio() {
        ...
        lblPregunta.setText(tools.getPregunta(tools.getData(data.Preguntas, 3, 2, 1)));
    ...
    private void initComponents() {
        ...
        pnlText.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/bgPreguntaBailesTipicos.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBailesTipicosPreguntas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
