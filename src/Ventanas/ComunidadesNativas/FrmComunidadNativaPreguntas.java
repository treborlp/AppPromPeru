 ...
 * @author 4ser
 */
public class FrmComunidadNativaPreguntas extends javax.swing.JFrame implements Runnable {
    ...
    public FrmComunidadNativaPreguntas() {
    ...
    public void inicio() {
        ...
        lblPregunta.setText(tools.getPregunta(tools.getData(data.Preguntas, 7, 2, 1)));
    ...
    private void initComponents() {
        ...
        pnlText.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/bgPreguntaComuNat.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmComunidadNativaPreguntas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
