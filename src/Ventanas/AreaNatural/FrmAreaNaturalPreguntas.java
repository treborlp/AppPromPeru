 ...
 * @author 4ser
 */
public class FrmAreaNaturalPreguntas extends javax.swing.JFrame implements Runnable {
    ...
    public FrmAreaNaturalPreguntas() {
    ...
    public void inicio() {
        ...
        lblPregunta.setText(tools.getPregunta(tools.getData(data.Preguntas, 6, 2, 1)));
    ...
    private void initComponents() {
        ...
        pnlText.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/bgPreguntaAreasNaturales.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAreaNaturalPreguntas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
